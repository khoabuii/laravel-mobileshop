    ...
    <div class="row">
      ...
      <div class="collapse navbar-collapse" id="main-mav-top">
        ...
        <div class="md-form my-0">
            <input class="form-control"  required type="text" placeholder="Search" aria-label="Search" name="result">
        ...
        <ul class="nav navbar-nav">
          ...
          <li>
            ...
            @endforeach
          <li>
            <a style="color:yellow;" href="{!!url('blog')!!}">| BÀI VIẾT |</a>
          </li>
        </ul>
          ...
          @if(Auth::check())
          <li class="dropdown">
            <a  class="dropdown-toggle" data-toggle="dropdown"> <span class="glyphicon glyphicon-shopping-cart"><span class="badge">{{count($cart1)}}</span></span><b class="caret"></b></a>
            <ul class="dropdown-menu" style="right:0; left: auto; min-width: 350px;">
              ...
              <div class="table-responsive">
                ...
                @endforeach
                  ...
                  <a href="{!!url('/cart/deleteAll/'.Auth::user()->id)!!}" type="button" class="btn btn-danger pull-right"> Xóa </a>
              </div>
              @else
                <div class="table-responsive">
                  <table class="table table-hover" >
